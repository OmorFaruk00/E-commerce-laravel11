...
<head>
    ...
    <link href="{{ asset('asset/animate/animate.min.css')}}" rel="stylesheet">
...
<body>
    ...
    <script src="{{ asset('asset/wow/wow.min.js')}}"></script>
    <script src="{{ asset('asset/easing/easing.min.js')}}"></script>
    <script src="{{ asset('asset/waypoints/waypoints.min.js')}}"></script>
    <script src="{{ asset('asset/counterup/counterup.min.js')}}"></script>
