...
<div class="col-lg-8 col-md-10 col-sm-12 mx-auto py-5">
	<form id="accessControlForm" method="POST" action="javaScript:;">
		<div class="card mx-auto mb-3">
			<div class="card-header h4 text-center">Assign Special Permission</div>
			<div class="card-body">	
				
				<div class="form-group">
					<label for="brand_id">User Name</label>
					<select id="user_id" class="form-control select-user" name="user_id">
...
$(document).ready(function() {
	$("#accessControlForm" ).validate({
        ...
        submitHandler: function() {
			axios.post('{{ env('APIP_URL') }}/store_special_permission', $('#accessControlForm').serialize())
	...
	$("#user_id").change(function(){
		var id = $(this).val();
		axios.get('{{ env('APP_URL') }}/permission/user/'+id)
		.then(function (response) {
