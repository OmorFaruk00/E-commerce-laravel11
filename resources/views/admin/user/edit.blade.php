            ...
            <div class="card card-primary">
                ...
                <form action="{{ route('user.update',$user->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <select id="role-select" class="form-control select-role" name="role_id">
                                        ...
                                        <option value="{{ $role->id }}" {{ $role->id == ($selectRole->id ?? '') ? 'selected' : '' }}>{{ $role->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('role_id')
                                    <small class="text-danger">{{ $message }}</small>
                        ...
                        <div class="mt-2">                                    
                            <img src="{{asset($user->image)}}" id="imageShow" alt="Selected Image" class="img-thumbnail" style=" width: 100px; height:100px" />
                        </div>
